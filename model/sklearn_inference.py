"""
Oral Cancer Detection - Model Inference Module (scikit-learn version)
This module handles model inference for new images using scikit-learn models.
"""
...
class OralCancerPredictor:
    """
    Class to handle predictions for oral cancer detection using scikit-learn models.
    """
    ...
    def __init__(self, model_path=None, image_size=(224, 224)):
        ...
        # Load metadata
        metadata_path = self.model_path.replace('_model.pkl', '_metadata.pkl')
        ...
        if os.path.exists(scaler_path):
            ...
            self.scaler = None
            logger.warning("Feature scaler not found. Predictions may be inaccurate.")
    ...
    def predict(self, image, return_visualization=False):
        ...
        try:
            ...
            if len(self.class_names) == 2:
                cancer_idx = self.class_names.index('Cancer') if 'Cancer' in self.class_names else 0
...
if __name__ == "__main__":
    # Example usage
    model_path = "model/checkpoints/latest_svm_model.pkl"
